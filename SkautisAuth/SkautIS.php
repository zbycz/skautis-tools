...
if(isset($_GET['debugger']) OR ZAPNI_NETTE_DEBUG){
...
require_once 'classes/OrganizationUnit.php';
require_once 'classes/UserManagement.php';
require_once 'classes/OrganizationUnitHelper.php';
require_once 'classes/AnonymServiceHelper.php';
